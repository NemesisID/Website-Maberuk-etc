...
const categories = [...new Set(umkmList.map((s) => s.category))].sort();
              ...
              {paginatedStores.map((store) => (
                ...
                >
                  <div className="relative h-40">
                    <Image src={store.heroImage} alt={store.name} fill className="object-cover group-hover:scale-105 transition-transform duration-500" unoptimized />
                  </div>
