...
export default function HomeClient({ initialUmkmList }: { initialUmkmList: any[] }) {
    ...
    <div className="min-h-screen flex flex-col bg-white text-gray-900 font-sans">
      ...
      <section id="direktori" className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {initialUmkmList.slice(0, 12).map((item) => (
  <Link
    key={item.slug}
  ...
  >
    <div className="relative h-40">
      <Image src={item.hero_image || item.heroImage} alt={item.name} fill className="object-cover group-hover:scale-105 transition-transform duration-500" unoptimized />
    </div>
